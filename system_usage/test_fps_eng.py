...
names = [
    ("FPS", "FPS with VBO", "FPS without VBO", "tab:blue", "tab:cyan", df_vbo["FPS"], df_no_vbo["FPS"]),
    ("Render Time (ms)", "Render Time with VBO", "Render Time without VBO", "tab:orange", "gold", df_vbo["RenderTime_ms"], df_no_vbo["RenderTime_ms"])
]
