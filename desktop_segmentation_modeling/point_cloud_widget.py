    ...
    class VulkanWidget(QWidget):
        ...
        def _init_uniform_buffer(self):
            ...
            try:
                ...
                self._update_buffer_data(self.uniform_buffer, self.uniform_memory, initial_mvp.flatten())
            except Exception as e:
        ...
        def _update_buffer_data(self, buffer, memory, data):
            ...
            # Маппинг памяти
            mapped_memory = vk.vkMapMemory(self.device, memory, 0, data_size, 0)
            try:
                import ctypes
                ctypes.memmove(mapped_memory, data.ctypes.data, data_size)
            finally:
